...
Infer a sensible ISO date from natural language (e.g. "come October" → the 1st of the next October). "general" clears a focus back to normal event-based training. Only emit a proposal when they're genuinely asking to change the plan.`;
