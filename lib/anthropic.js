...
// Defaults to the same Haiku model; set ANTHROPIC_PLAN_MODEL=claude-sonnet-4-6 to upgrade
// just this call if you ever want richer plans, without paying Sonnet rates elsewhere.
export const PLAN_MODEL = process.env.ANTHROPIC_PLAN_MODEL || MODEL;
