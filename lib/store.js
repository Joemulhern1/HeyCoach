...
const EMPTY = { profile: null, plan: null, block: null, events: [], availability: [], sessions: [], weights: [], strava: null, coachChat: [], nutritionPlan: null, focuses: [], weekHours: {}, progression: { recovery: 5, endurance: 5, tempo: 5, threshold: 5, vo2: 5, strength: 5 } };
