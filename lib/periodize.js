...
export const ARCHETYPES = {
  gc: { label: "GC / Stage racer", base: ["end", "tempo", "ss", "long"], build: ["ss", "thr", "vo2", "long"], peak: ["thr", "vo2", "thr", "end"], note: "all-round threshold, endurance & fatigue-resistance for GC racing" },
  roadrace: { label: "Road racer", base: ["end", "tempo", "ss", "long"], build: ["thr", "vo2", "anaerobic", "long"], peak: ["vo2", "anaerobic", "thr", "crit"], note: "repeated hard efforts, attacks and a finishing kick for road races" },
  crit: { label: "Criterium racer", base: ["end", "tempo", "vo2", "ss"], build: ["vo2", "anaerobic", "crit", "thr"], peak: ["anaerobic", "crit", "sprint", "vo2"], note: "explosive repeatability, cornering surges and a sprint for crits" },
  classics: { label: "Classics rider", base: ["end", "tempo", "ss", "long"], build: ["thr", "vo2", "anaerobic", "long"], peak: ["vo2", "anaerobic", "crit", "thr"], note: "punch, repeated hard efforts & endurance for the classics" },
  cyclocross: { label: "Cyclocross racer", base: ["end", "tempo", "vo2", "ss"], build: ["vo2", "anaerobic", "crit", "thr"], peak: ["anaerobic", "vo2", "crit", "sprint"], note: "repeated 30–60s max efforts and fast recovery for CX" },
  climber: { label: "Mountain goat (climber)", base: ["end", "ss", "tempo", "long"], build: ["ss", "thr", "vo2", "long"], peak: ["thr", "vo2", "thr", "long"], note: "sustained climbing power and watts-per-kilo" },
  tt: { label: "Time-trialist", base: ["end", "ss", "tempo", "long"], build: ["ss", "thr", "thr", "long"], peak: ["thr", "thr", "ss", "end"], note: "sustained threshold power and pacing for time trials" },
  granfondo: { label: "Gran fondo / sportive", base: ["end", "tempo", "ss", "long"], build: ["ss", "tempo", "thr", "long"], peak: ["ss", "thr", "end", "long"], note: "big aerobic endurance and all-day sustainable power" },
  endurance: { label: "Endurance / ultra", base: ["end", "tempo", "end", "long"], build: ["end", "ss", "tempo", "long"], peak: ["ss", "end", "tempo", "long"], note: "deep aerobic base and fatigue resistance for long days" },
...
export const ARCHETYPE_KEYS = ["gc", "roadrace", "crit", "classics", "cyclocross", "climber", "tt", "granfondo", "endurance", "sprinter"];
...
export function buildSkeleton(profile, weights, events, availability, focuses, weekHours) {
  ...
  const arch = ARCHETYPES[profile.riderType] || ARCHETYPES.gc;
  ...
  const weeks = starts.map((ms, wi) => {
    ...
    const archPool = arch[phase === "Base" ? "base" : phase === "Build" ? "build" : phase === "Peak" ? "peak" : null];
  ...
  return {
    ...
    riderType: profile.riderType || "gc",
